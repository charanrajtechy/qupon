...
function Terms() {
  return (
    <LegalLayout eyebrow="Legal" title="Terms & Conditions" updated="Tuesday 22 July 2025">
      ...
      <h2><strong>1. About Qupon</strong></h2>
      ...
      <h2><strong>3. User Account & Verification</strong></h2>
      <ul>
      ...
      <h2><strong>4. Coupon Uploading Policy</strong></h2>
      <p>To upload a coupon, the user must provide:</p>
      <ol>
        <li><strong>Brand Name</strong> (Mandatory).</li>
        <li><strong>Coupon Code</strong> (Mandatory).</li>
        <li><strong>Coupon Heading</strong> (Mandatory).</li>
        <li><strong>Expiry Date</strong> (Mandatory).</li>
        <li><strong>Screenshot/Terms & Conditions</strong> (Mandatory — single upload).</li>
      ...
      <h2><strong>5. Coupon Browsing & Purchase</strong></h2>
      <ul>
      ...
      <h2><strong>6. Profile Levels & Upload Limits</strong></h2>
      <ul>
      ...
      <h2><strong>7. Earnings & Payments</strong></h2>
      <ul>
      ...
      <h2><strong>8. Admin Panel & Rights</strong></h2>
      <ul>
      ...
      <h2><strong>9. User Obligations</strong></h2>
      <ul>
      ...
      <h2><strong>11. Third-Party Services Disclaimer</strong></h2>
      ...
      <h2><strong>12. Intellectual Property</strong></h2>
      <ul>
      ...
      <h2><strong>13. Modifications</strong></h2>
      <ul>
      ...
      <h2><strong>15. Contact</strong></h2>
